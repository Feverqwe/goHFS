...
const PlayerContainer = styled('div')(({theme}) => ({
  ...
  '.video-js .vjs-big-play-button:hover, .video-js .vjs-big-play-button:focus-visible': {
  ...
  '.video-js:is(.vjs-layout-small, .vjs-layout-x-small) .vjs-control-bar': {
    paddingRight: 0,
    paddingLeft: 0,
  },

  '.video-js:is(.vjs-layout-small, .vjs-layout-x-small) .vjs-control.vjs-button': {
    marginRight: '3px',
    marginLeft: '3px',
  },
  ...
  '.video-js .vjs-control-bar .vjs-button > .vjs-icon-placeholder::before': {
    fontSize: '2.4em',
    lineHeight: CONTROL_TARGET_SIZE,
  },
  ...
  '@media (prefers-reduced-motion: reduce)': {
    '.video-js .vjs-big-play-button, .video-js .vjs-control-bar, .video-js .vjs-volume-panel, .video-js .vjs-volume-control, .video-js .vjs-custom-subtitles':
      {
        transition: 'none',
      },
